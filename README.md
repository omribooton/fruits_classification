...
some notes: 
you will have to get an premmision to use the drive data else you will have to chage all path to your own.
drive data was download to drive folder (only orange,apples and banans folders) while kaggle imports directly from Kaggle.
There are some changes between the presentation and other resualt, locking seed for the CNN accured after the presentation happend.
